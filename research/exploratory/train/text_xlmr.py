"""
XLM-RoBERTa Canonical Training + Phase 3 Export
...
Local usage:
    python -m src.train.text_xlmr --raw-dir data/raw --out-dir artifacts/exports ...

Colab usage:
    python -m src.train.text_xlmr --raw-dir /content/drive/.../data_raw ...
"""
...
class XLMRConfig:
    ...
    # Model
    model_name: str = "xlm-roberta-base"  # or "FacebookAI/xlm-roberta-large"
    ...
    export_name: str = "xlmr_canonical"  # Export name
...
def run_xlmr_canonical(cfg: XLMRConfig) -> Dict[str, Any]:
    """
    Canonical XLM-RoBERTa training + Phase 3 export + B4-verifiable contract.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="XLM-RoBERTa Canonical Training + Export")
    ...
    parser.add_argument("--ckpt-dir", type=str, default="checkpoints/text_xlmr", help="Checkpoint directory")
    ...
    parser.add_argument("--export-name", type=str, default="xlmr_canonical", help="Model name for export")
    ...
    print("="*80)
    print("XLM-RoBERTa Canonical Training Configuration")
    print("="*80)
