"""
mDeBERTa-v3 Canonical Training + Phase 3 Export
...
Local usage:
    python -m src.train.text_mdeberta --raw-dir data/raw --out-dir artifacts/exports ...

Colab usage:
    python -m src.train.text_mdeberta --raw-dir /content/drive/.../data_raw ...
"""
...
class MDeBERTaConfig:
    ...
    # Training
    max_length: int = 512             # mDeBERTa supports longer sequences
    ...
    export_name: str = "mdeberta_canonical"  # Export name
...
def run_mdeberta_canonical(cfg: MDeBERTaConfig) -> Dict[str, Any]:
    """
    Canonical mDeBERTa-v3 training + Phase 3 export + B4-verifiable contract.
    ...
    export_result = export_predictions(
        ...
        y_true=y_true,
        extra_meta={
            "source": "src/train/text_mdeberta.py",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="mDeBERTa-v3 Canonical Training + Export")
    ...
    parser.add_argument("--ckpt-dir", type=str, default="checkpoints/text_mdeberta", help="Checkpoint directory")

    parser.add_argument("--epochs", type=int, default=6, help="Number of epochs")
    parser.add_argument("--batch-size", type=int, default=16, help="Batch size")
    parser.add_argument("--lr", type=float, default=2e-5, help="Learning rate")
    parser.add_argument("--max-length", type=int, default=512, help="Max sequence length (mDeBERTa supports 512)")

    # Model selection
    parser.add_argument("--model", type=str, default="microsoft/mdeberta-v3-base",
                        help="HuggingFace model name (default: microsoft/mdeberta-v3-base)")
    ...
    parser.add_argument("--export-name", type=str, default="mdeberta_canonical", help="Model name for export")
    ...
    print("="*80)
    print("mDeBERTa-v3 Canonical Training Configuration")
    print("="*80)
    ...
    result = run_mdeberta_canonical(cfg)
