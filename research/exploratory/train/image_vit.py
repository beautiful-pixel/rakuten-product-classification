"""
ViT Canonical Training + Phase 3 Export
...
Local usage:
    python -m src.train.image_vit --raw-dir data/raw --img-dir data/raw/images/image_train ...

Colab usage:
    python -m src.train.image_vit --raw-dir /content/drive/.../data_raw --img-dir /content/images/... ...
"""
...
class ViTConfig:
    ...
    # Model
    vit_model_name: str = "vit_tiny_patch16_224"  # FIXED: timm model name
    vit_pretrained: bool = True                   # FIXED: pretrained weights
    ...
    model_name: str = "vit_rerun_canonical_smoke"  # Export name
...
def _build_vit(num_classes: int, dropout_rate: float, model_name: str = "vit_tiny_patch16_224", pretrained: bool = True) -> nn.Module:
    """
    ...
    # FIXED: Allow model_name and pretrained to be configurable
...
def run_vit_canonical(cfg: ViTConfig) -> Dict[str, Any]:
    ...
    FIXED: Renamed from run_vit_colab for local/Colab dual compatibility.
    """
    ...
    # 5) Model (FIXED: Pass model_name and pretrained)
    model = _build_vit(
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ViT Canonical Training + Export")
    ...
    # FIXED: Model selection and pretrained control
    parser.add_argument("--model", type=str, default="vit_tiny_patch16_224",
                        help="timm model name (default: vit_tiny_patch16_224)")
    ...
    parser.add_argument("--export-name", type=str, default="vit_rerun_canonical_smoke", help="Model name for export")
    ...
    print("="*80)
    print("ViT Canonical Training Configuration")
    print("="*80)
